...
const TextContent = ({ count }: { count: number }) => {
    ...
    return <div className="para">
        ...
        <p><span  style={{display: "none"}}>Nếu có bất kỳ thắc mắc nào, đừng ngân ngại liên hệ với <a target="#" href='https://redshop.vn'><span className="red">RED</span>shop.vn</a> qua email, số điện hoạt hoặc fanpage nhé 😊</span>
            
            <span className="info">🏠 Fanpage: </span><a target="#" href="https://www.facebook.com/REDshopVNSteamDeck">fb.com/REDshopVNSteamDeck</a>
            <br />
